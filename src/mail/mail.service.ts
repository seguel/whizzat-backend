...
export class MailService {
  ...
  async enviarQuestionarioNotificacoes(
    email: string,
    nome: string,
    language: string,
    perfil_id: number,
    ...
    const subjectPrefixo = this.i18n.translate(
      `common.mail.formulario_${perfil_id === 1 ? 'candidato' : 'avaliador'}.assunto_prefixo`,
      { lang: language },
    );

    const subject = `${subjectPrefixo}`;
    ...
    const { error } = await this.resend.emails.send({
      ...
      <div style="width: 100%; background-color: #f4f6f8; padding: 40px 0; font-family: Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 35px; border: 1px solid #e5e7eb;">
          ...
          <h2 style="font-size: 22px; color: #111827; text-align: center; margin-bottom: 25px;">
            ${this.i18n.translate(`common.mail.formulario_${perfil_id === 1 ? 'candidato' : 'avaliador'}.titulo`, { lang: language })}
          </h2>

          <p style="font-size: 16px; color: #374151; margin-bottom: 15px;">
            ${this.i18n.translate(`common.mail.formulario_${perfil_id === 1 ? 'candidato' : 'avaliador'}.saudacao`, { lang: language })} <strong>${nome}</strong>,
          </p>

          <p style="font-size: 15px; color: #4b5563; margin-bottom: 20px;">
            ${this.i18n.translate(`common.mail.formulario_${perfil_id === 1 ? 'candidato' : 'avaliador'}.introducao`, { lang: language })} <br /><br />
            ${this.i18n.translate(`common.mail.formulario_${perfil_id === 1 ? 'candidato' : 'avaliador'}.introducao_2`, { lang: language })}<br /><br />
            ${this.i18n.translate(`common.mail.formulario_${perfil_id === 1 ? 'candidato' : 'avaliador'}.introducao_3`, { lang: language })}
          </p>    
          ...
          <div style="text-align: center; margin-bottom: 35px;">
            <a href="${dashboardLink}"
              style="background-color: #16a34a; 
                      ...
                      font-size: 15px;
                      display: inline-block;">
              ${this.i18n.translate(`common.mail.formulario_${perfil_id === 1 ? 'candidato' : 'avaliador'}.btn_acessar`, { lang: language })}
            </a>
          </div>
  ...
  async enviarAgendaNotificacoes(
    email: string,
    nome: string,
    language: string,
    perfil_id: number,
    ...
    const subjectPrefixo = this.i18n.translate(
      `common.mail.agenda_${perfil_id === 1 ? 'candidato' : 'avaliador'}.assunto_prefixo`,
      { lang: language },
    );
      ...
      html: `
        <div style="width: 100%; background-color: #f4f6f8; padding: 40px 0; font-family: Arial, sans-serif;">
          <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 35px; border: 1px solid #e5e7eb;">
            ...
            <h2 style="font-size: 22px; color: #111827; text-align: center; margin-bottom: 25px;">
              ${this.i18n.translate(`common.mail.agenda_${perfil_id === 1 ? 'candidato' : 'avaliador'}.titulo`, { lang: language })}
            </h2>

            <p style="font-size: 16px; color: #374151; margin-bottom: 15px;">
              ${this.i18n.translate(`common.mail.agenda_${perfil_id === 1 ? 'candidato' : 'avaliador'}.saudacao`, { lang: language })} <strong>${nome}</strong>,
            </p>

            <p style="font-size: 15px; color: #4b5563; margin-bottom: 20px;">
              ${this.i18n.translate(`common.mail.agenda_${perfil_id === 1 ? 'candidato' : 'avaliador'}.introducao`, { lang: language })} <br /><br />
              ${this.i18n.translate(`common.mail.agenda_${perfil_id === 1 ? 'candidato' : 'avaliador'}.introducao_2`, { lang: language })}<br /><br />
              ${this.i18n.translate(`common.mail.agenda_${perfil_id === 1 ? 'candidato' : 'avaliador'}.introducao_3`, { lang: language })}
            </p>    
          ...
          <div style="text-align: center; margin-bottom: 35px;">
            <a href="${dashboardLink}"
              style="background-color: #16a34a; 
                      ...
                      font-size: 15px;
                      display: inline-block;">
              ${this.i18n.translate(`common.mail.agenda_${perfil_id === 1 ? 'candidato' : 'avaliador'}.btn_acessar`, { lang: language })}
            </a>
          </div>
  ...
  async enviarFinalizadoNotificacoes(
    email: string,
    nome: string,
    language: string,
    dashboardLink: string,
    ...
    const subjectPrefixo = this.i18n.translate(
      `common.mail.avaliacao_finalizado.assunto_prefixo`,
      { lang: language },
    );
      ...
      html: `
        <div style="width: 100%; background-color: #f4f6f8; padding: 40px 0; font-family: Arial, sans-serif;">
          <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 35px; border: 1px solid #e5e7eb;">
            ...
            <h2 style="font-size: 22px; color: #111827; text-align: center; margin-bottom: 25px;">
              ${this.i18n.translate(`common.mail.avaliacao_finalizado.titulo`, { lang: language })}
            </h2>

            <p style="font-size: 16px; color: #374151; margin-bottom: 15px;">
              ${this.i18n.translate(`common.mail.avaliacao_finalizado.saudacao`, { lang: language })} <strong>${nome}</strong>,
            </p>

            <p style="font-size: 15px; color: #4b5563; margin-bottom: 20px;">
              ${this.i18n.translate(`common.mail.avaliacao_finalizado.introducao`, { lang: language })} <br /><br />
              ${this.i18n.translate(`common.mail.avaliacao_finalizado.introducao_2`, { lang: language })}<br /><br />
              ${this.i18n.translate(`common.mail.avaliacao_finalizado.introducao_3`, { lang: language })}
            </p>  
              ...
              <div style="text-align: center; margin-bottom: 35px;">
                <a href="${dashboardLink}"
                  style="background-color: #16a34a; 
                          ...
                          font-size: 15px;
                          display: inline-block;">
                  ${this.i18n.translate(`common.mail.avaliacao_finalizado.btn_acessar`, { lang: language })}
                </a>
              </div>
  ...
  async enviarConviteRecrutadorNotificacoes(
    email: string,
    nome: string,
    language: string,
    quantidade: number,
    ...
    const subject = this.i18n.translate(
      'common.mail.convite_recrutador.assunto_prefixo',
      {
        lang: language,
        args: {
          quantidade,
    ...
    const { error } = await this.resend.emails.send({
      ...
      <div style="width: 100%; background-color: #f4f6f8; padding: 40px 0; font-family: Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 35px; border: 1px solid #e5e7eb;">
          ...
          <h2 style="font-size: 22px; color: #111827; text-align: center; margin-bottom: 25px;">
            ${this.i18n.translate('common.mail.convite_recrutador.titulo', {
              lang: language,
              args: {
                quantidade,
              },
          ...
          <p style="font-size: 16px; color: #374151; margin-bottom: 15px;">
            ${this.i18n.translate('common.mail.convite_recrutador.saudacao', {
              lang: language,
            })} <strong>${nome}</strong>,
          </p>
          ...
          <p style="font-size: 15px; color: #4b5563; margin-bottom: 20px;">
            ${this.i18n.translate(
              quantidade === 1
                ? 'common.mail.convite_recrutador.introducao'
                : 'common.mail.convite_recrutador.introducao_varios',
              {
                lang: language,
                args: {
                  quantidade,
            ...
            ${this.i18n.translate(
              'common.mail.convite_recrutador.introducao_2',
              { lang: language },
            )}
          </p>
          ...
          <div style="text-align: center; margin-bottom: 35px;">
            <a href="${dashboardLink}"
              style="background-color: #16a34a; 
                    ...
                    display: inline-block;">
              ${this.i18n.translate(
                'common.mail.convite_recrutador.btn_acessar',
                { lang: language },
              )}
            </a>
          </div>
  ...
  async enviarConviteRecrutadorManualNotificacoes(
    email: string,
    nome: string,
    language: string,
    quantidade: number,
    ...
    const subject = this.i18n.translate(
      'common.mail.convite_recrutador_manual.assunto_prefixo',
      {
        lang: language,
        args: {
          quantidade,
    ...
    const { error } = await this.resend.emails.send({
      ...
      <div style="width: 100%; background-color: #f4f6f8; padding: 40px 0; font-family: Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 35px; border: 1px solid #e5e7eb;">
          ...
          <h2 style="font-size: 22px; color: #111827; text-align: center; margin-bottom: 25px;">
            ${this.i18n.translate(
              'common.mail.convite_recrutador_manual.titulo',
              {
                lang: language,
                args: {
                  quantidade,
          ...
          <p style="font-size: 16px; color: #374151; margin-bottom: 15px;">
            ${this.i18n.translate(
              'common.mail.convite_recrutador_manual.saudacao',
              {
                lang: language,
              },
            )} <strong>${nome}</strong>,
          ...
          <p style="font-size: 15px; color: #4b5563; margin-bottom: 20px;">
            ${this.i18n.translate(
              quantidade === 1
                ? 'common.mail.convite_recrutador_manual.introducao'
                : 'common.mail.convite_recrutador_manual.introducao_varios',
              {
                lang: language,
                args: {
                  quantidade,
           ...
           ${this.i18n.translate(
             'common.mail.convite_recrutador_manual.introducao_2',
             {
               lang: language,
             },
           )}
            ...
            ${this.i18n.translate(
              'common.mail.convite_recrutador_manual.introducao_3',
              {
                lang: language,
              },
            )}
          ...
          <div style="text-align: center; margin-bottom: 35px;">
            <a href="${dashboardLink}"
              style="background-color: #16a34a; 
                    ...
                    display: inline-block;">
              ${this.i18n.translate(
                'common.mail.convite_recrutador_manual.btn_acessar',
                {
                  lang: language,
                },
              )}
  ...
  async enviarRespostaConviteRecrutadorNotificacoes(
    email: string,
    nome: string,
    language: string,
    ...
    const { error } = await this.resend.emails.send({
      ...
      <div style="width: 100%; background-color: #f4f6f8; padding: 40px 0; font-family: Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 35px; border: 1px solid #e5e7eb;">
          ...
          <h2 style="font-size: 22px; color: #111827; text-align: center; margin-bottom: 25px;">
            ${this.i18n.translate(
              `common.mail.resposta_convite_recrutador.${chave}.titulo`,
              { lang: language },
            )}
          </h2>
          ...
          <p style="font-size: 16px; color: #374151; margin-bottom: 15px;">
            ${this.i18n.translate(
              'common.mail.resposta_convite_recrutador.saudacao',
              { lang: language },
            )}
            <strong>${nome}</strong>,
          </p>
          ...
          <div style="text-align: center; margin-bottom: 35px;">
            ...
            >
              ${this.i18n.translate(
                'common.mail.resposta_convite_recrutador.btn_acessar',
                { lang: language },
              )}
            </a>
          </div>
  ...
  async enviarRespostaAgendaRecrutadorNotificacoes(
    email: string,
    nome: string,
    language: string,
    nomeCandidato: string,
    ...
    const chave = aceito ? 'aceita' : 'recusada';

    const locale = language?.toLowerCase().startsWith('en') ? 'en-US' : 'pt-BR';
    ...
    const { error } = await this.resend.emails.send({
      ...
      <div style="width: 100%; background-color: #f4f6f8; padding: 40px 0; font-family: Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 35px; border: 1px solid #e5e7eb;">
          ...
          <h2 style="font-size: 22px; color: #111827; text-align: center; margin-bottom: 25px;">
            ${this.i18n.translate(
              `common.mail.resposta_agenda_recrutador.${chave}.titulo`,
              {
                lang: language,
              },
            )}
          ...
          <p style="font-size: 16px; color: #374151; margin-bottom: 15px;">
            ${this.i18n.translate(
              'common.mail.resposta_agenda_recrutador.saudacao',
              {
                lang: language,
              },
            )}
          ...
          <div style="text-align: center; margin-bottom: 35px;">
            ...
            >
              ${this.i18n.translate(
                'common.mail.resposta_agenda_recrutador.btn_acessar',
                {
                  lang: language,
                },
              )}
